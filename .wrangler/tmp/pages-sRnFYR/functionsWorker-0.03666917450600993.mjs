...
var onRequestPost = /* @__PURE__ */ __name(async ({ request, env }) => {
  ...
  const systemPrompt = lang === "zh" ? `\u4F60\u662F\u4E00\u4E2A AI \u63D0\u793A\u8BCD\u5DE5\u7A0B\u5E08\u3002\u7528\u6237\u63CF\u8FF0\u4ED6\u4EEC\u60F3\u8BA9 AI \u5B8C\u6210\u7684\u4EFB\u52A1\u3002\u4F60\u7684\u8F93\u51FA\u662F AI \u53EF\u76F4\u63A5\u6267\u884C\u7684 System Prompt\uFF08Markdown \u683C\u5F0F\uFF09\u3002
...
\u8981\u6C42\uFF1A\u5177\u4F53\u3001\u53EF\u6267\u884C\u3001\u4E0D\u6A21\u7CCA\u3002\u53EA\u8F93\u51FA System Prompt\uFF0C\u4E0D\u8981\u52A0\u89E3\u91CA\u3002` : `You are a prompt engineer. The user describes what they want an AI to do. Output a System Prompt (in Markdown) that an AI can execute directly.
...
Requirements: Specific, executable, unambiguous. Output only the System Prompt, no explanation.`;
  try {
    ...
    const prompt = response.response?.trim() || "";
    if (!prompt) {
      return new Response(
...
// ../.wrangler/tmp/pages-sRnFYR/functionsRoutes-0.33349434222213936.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-1Ij2bt/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-1Ij2bt/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.03666917450600993.mjs.map
